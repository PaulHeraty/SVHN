...
if graph_type == 1:    
    ...
    with graph.as_default():
        ...
        logits_num_digits = model_num_digits(tf_train_dataset)
        logits_digit1 = model_digit1(tf_train_dataset)
        logits_digit2 = model_digit2(tf_train_dataset)
        logits_digit3 = model_digit3(tf_train_dataset)
        ...
        valid_prediction_num_digits = tf.nn.softmax(model_num_digits(tf_valid_dataset))
        valid_prediction_digit1 = tf.nn.softmax(model_digit1(tf_valid_dataset))
        valid_prediction_digit2 = tf.nn.softmax(model_digit2(tf_valid_dataset))
        valid_prediction_digit3 = tf.nn.softmax(model_digit3(tf_valid_dataset))
        
        test_prediction_num_digits = tf.nn.softmax(model_num_digits(tf_test_dataset))
        test_prediction_digit1 = tf.nn.softmax(model_digit1(tf_test_dataset))
        test_prediction_digit2 = tf.nn.softmax(model_digit2(tf_test_dataset))
        test_prediction_digit3 = tf.nn.softmax(model_digit3(tf_test_dataset))
